...
bitcore-message-arrow adds support for verifying and signing arrow messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install Arrowchain/bitcore-message-arrow
```

```sh
bower install Arrowchain/bitcore-message-arrow
```

To sign a message:

```javascript
var bitcore = require('bitcore-lib-arrow');
var Message = require('bitcore-message-arrow');
